...
AgentMonitor **watch seats** get `!bored` from the monitor itself (start / after DONE / idle; no LLM) — see AgentMonitor FR #100 and `tools/Watch-AgentHealth/Watch-AgentHealth.ps1`. Shop LLM workers still append `!bored` themselves.
