> **Supersession (FIX for #36 / MRB #158):** Channel change-talk and tray/digest `!bobiverse` landed via [agentic_build#74](https://github.com/SimonBarnett/agentic_build/issues/74) / [agentic_irc#6](https://github.com/SimonBarnett/agentic_irc/issues/6). Live law: `docs/bobiverse.md` + `docs/feature-request-bobiverse-channel-talk-tray-pull-2026-09-21.md` + digest FR #142. This file keeps Simon's 2026-09-20 park text. Do **not** re-implement join-DM briefing or a second human `!bobiverse` dialect from this park.
