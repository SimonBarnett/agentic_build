...
That `-Chair` switch opens the MODE2 moot for the **builder** seat. It is not Jeeves. On ionos, after `BobIrcd` is up, install the digest chair with `tools/Install-BobJeeves.ps1` (see **Jeeves** above).
