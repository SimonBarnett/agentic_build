...
Parked: quieter conversational talk (one field per message, only when it changes; join briefing as a DM). See `docs/feature-request-bobiverse-quiet-talk-2026-09-20.md` and issue #36. Protocol work also belongs on `SimonBarnett/agentic_irc`.
