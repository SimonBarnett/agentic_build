...
Write-Host 'https://github.com/apps/cursor/installations/new?target_id=2916380'
...
if (-not $NoBrowser) {
    Start-Process 'https://github.com/apps/cursor/installations/new?target_id=2916380'
